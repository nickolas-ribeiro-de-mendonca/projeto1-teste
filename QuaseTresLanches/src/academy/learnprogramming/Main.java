...
public class Main{
    ...
    public static void main(String[] args) {
        ...
        menuInicial.adicionarItem("escolhaMenuPrincipal", "Realizar novo pedido");
        menuInicial.adicionarItem("CLIENTES", "Gerenciar clientes");
        menuInicial.imprimir();
        opcao = menuInicial.lerOpcao();
        if (opcao == 1){
            menu();
        } else if (opcao==2) {
    ...
    public static void menu(){
        Menu menuComida = new Menu("MENU DE OPCAOES");
        menuComida.adicionarItem("PIZZA","Pizza");
        menuComida.adicionarItem("LANCHE","Lanche");
        menuComida.adicionarItem("SALGADOS","Salgado");
        menuComida.adicionarItem("MOSTRAR PEDIDOS","Mostrar pedidos");
        menuComida.adicionarItem("EXCLUIR","Excluir item do carrinho");
        menuComida.imprimir();
        opcao = menuComida.lerOpcao();
        switch (opcao){
            case 1:
